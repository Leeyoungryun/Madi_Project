...
public class phoneme_test {
	public static void main(String[] args) throws IOException {
		...
		PhonemeKernelClassifier Classifier = new PhonemeKernelClassifier("data/gee.txt", 3,
				0.8, true);
		PhonemeTextEngine TextEmotion = PhonemeTextEngine.getLearnedInstance(Classifier);
		
		//데이터셋을 학습한 SVM을 파일로 저장
		ObjectOutputStream dat = new ObjectOutputStream(new FileOutputStream("data/gee.dat"));
