...
public class phoneme_test {
	public static void main(String[] args) throws IOException {
		...
		PhonemeKernelClassifier Classifier = new PhonemeKernelClassifier(
				"data/ex_0725.txt", 3, 0.7, true);
		PhonemeTextEngine TextEmotion = PhonemeTextEngine
				.getLearnedInstance(Classifier);
