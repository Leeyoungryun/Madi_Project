...
INSERT INTO MEMBER (MEMBER_NUM, EMAIL, PW, NAME, PHONE, LOCAL) VALUES (SEQ_MEMBER_NUM.NEXTVAL, 'test@naver.com', '123', 'name TEST', '01033331111',	'Local TEST');
COMMIT;
INSERT INTO MUSIC (MUSIC_NUM, TITLE, SINGER, EMOTION, URL) VALUES (SEQ_MUSIC_NUM.NEXTVAL, 'title TEST', 'singer TEST', 'LOVE', '0');
COMMIT;
INSERT INTO MEMO (MEMO_NUM, MEMBER_NUM, TITLE, CONTENT, HASHTAG1, HASHTAG2, HASHTAG3, BACK, WRITEDAY, MUSIC_NUM) VALUES (SEQ_MEMO_NUM.NEXTVAL, 1, 'titleTEST', 'contentTEST', 'hash1', 'hash2', 'hash3', 1, SYSDATE,	1);
COMMIT;	